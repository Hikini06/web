document.addEventListener('DOMContentLoaded', () => {
    ...
    // Thêm chức năng kiểm tra độ dài từ khóa tìm kiếm
    ...
    headerSearchForm.addEventListener('submit', (e) => {
        ...
        if (query.length < 2) {
            e.preventDefault(); // Ngăn không cho biểu mẫu gửi đi
            alert('Vui lòng nhập 2 ký tự trở lên');
            headerSearchInput.focus(); // Tự động focus vào ô nhập liệu
        }
    });
